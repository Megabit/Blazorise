    ...
    public class PageEntryData
    {
        ...
        private Task<PageEntry[]> LoadData( ICacheEntry cacheEntry )
        {
            return Task.FromResult( new PageEntry[]
            {
                ...
                new PageEntry( "docs/services/message", "Message Provider", "Message service is used for quick user confirmation actions." ),
                new PageEntry( "docs/services/modal-provider", "Modal Provider", "Programatically instantiate modals with custom content." ),
                new PageEntry( "docs/services/notification", "Notification Provider", "Notification service is used to provide feedback to the user." ),
                new PageEntry( "docs/services/page-progress", "Page Progress Provider", "Page Progress service is used to provide a page loading indicator to the user." ),
