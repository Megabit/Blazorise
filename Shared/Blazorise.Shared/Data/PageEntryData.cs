    ...
    private Task<PageEntry[]> LoadData( ICacheEntry cacheEntry )
    {
        return Task.FromResult( new PageEntry[]
        {
            ...
            new PageEntry( "docs/pwa", "PWA" ),
                ...
                new PageEntry( "docs/extensions/datagrid/selection/single", "DataGrid Selection : Single", "Easily select and manage a single row of data with the Blazorise DataGrid's single selection feature. Select a row by clicking on it or programmatically, and access the selected data for further use." ),
            new PageEntry( "docs/extensions/datagrid/selection/multiple", "DataGrid Selection : Multiple", "Select and manage multiple rows of data with ease using the Blazorise DataGrid's multiple selection feature. Select rows by clicking on them or programmatically, and access the selected data for further use." ),
