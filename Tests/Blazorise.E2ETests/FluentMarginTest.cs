...
namespace Blazorise.E2ETests
{
    public class FluentMarginTest
    {
        ...
        [Theory]
        [InlineData( "m-xs-1", SpacingSize.Is1, Side.All, Breakpoint.Mobile )]
        ...
        [InlineData( "mt-xs-1", SpacingSize.Is1, Side.Top, Breakpoint.Mobile )]
        ...
        [InlineData( "mb-xs-1", SpacingSize.Is1, Side.Bottom, Breakpoint.Mobile )]
        ...
        [InlineData( "ml-xs-1", SpacingSize.Is1, Side.Left, Breakpoint.Mobile )]
        ...
        [InlineData( "mr-xs-1", SpacingSize.Is1, Side.Right, Breakpoint.Mobile )]
        ...
        [InlineData( "mx-xs-1", SpacingSize.Is1, Side.X, Breakpoint.Mobile )]
        ...
        [InlineData( "my-xs-1", SpacingSize.Is1, Side.Y, Breakpoint.Mobile )]
