...
namespace Blazorise.E2ETests
{
    public class FluentPaddingTest
    {
        ...
        [Theory]
        [InlineData( "p-xs-1", SpacingSize.Is1, Side.All, Breakpoint.Mobile )]
        ...
        [InlineData( "pt-xs-1", SpacingSize.Is1, Side.Top, Breakpoint.Mobile )]
        ...
        [InlineData( "pb-xs-1", SpacingSize.Is1, Side.Bottom, Breakpoint.Mobile )]
        ...
        [InlineData( "pl-xs-1", SpacingSize.Is1, Side.Left, Breakpoint.Mobile )]
        ...
        [InlineData( "pr-xs-1", SpacingSize.Is1, Side.Right, Breakpoint.Mobile )]
        ...
        [InlineData( "px-xs-1", SpacingSize.Is1, Side.X, Breakpoint.Mobile )]
        ...
        [InlineData( "py-xs-1", SpacingSize.Is1, Side.Y, Breakpoint.Mobile )]
