...
public class FluentPaddingTest
{
    ...
    [InlineData( "p-xxl-1", SpacingSize.Is1, Side.All, Breakpoint.Full2K )]
    ...
    [InlineData( "pt-xxl-1", SpacingSize.Is1, Side.Top, Breakpoint.Full2K )]
    ...
    [InlineData( "pb-xxl-1", SpacingSize.Is1, Side.Bottom, Breakpoint.Full2K )]
    ...
    [InlineData( "pl-xxl-1", SpacingSize.Is1, Side.Start, Breakpoint.Full2K )]
    ...
    [InlineData( "pr-xxl-1", SpacingSize.Is1, Side.End, Breakpoint.Full2K )]
    ...
    [InlineData( "px-xxl-1", SpacingSize.Is1, Side.X, Breakpoint.Full2K )]
    ...
    [InlineData( "py-xxl-1", SpacingSize.Is1, Side.Y, Breakpoint.Full2K )]
