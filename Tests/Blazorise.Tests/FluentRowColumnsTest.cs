...
public class FluentRowColumnsTest
{
    ...
    [InlineData( "row-cols-xxl-1", RowColumnsSize.Are1, Breakpoint.Full2K )]
    [InlineData( "row-cols-xxl-2", RowColumnsSize.Are2, Breakpoint.Full2K )]
    [InlineData( "row-cols-xxl-3", RowColumnsSize.Are3, Breakpoint.Full2K )]
    [InlineData( "row-cols-xxl-4", RowColumnsSize.Are4, Breakpoint.Full2K )]
    [InlineData( "row-cols-xxl-5", RowColumnsSize.Are5, Breakpoint.Full2K )]
    [InlineData( "row-cols-xxl-6", RowColumnsSize.Are6, Breakpoint.Full2K )]
