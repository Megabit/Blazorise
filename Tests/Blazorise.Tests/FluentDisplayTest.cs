...
public class FluentDisplayTest
{
    ...
    [InlineData( "d-xxl-none", DisplayType.None, DisplayDirection.Default, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-inline", DisplayType.Inline, DisplayDirection.Default, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-inline-block", DisplayType.InlineBlock, DisplayDirection.Default, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-block", DisplayType.Block, DisplayDirection.Default, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-table", DisplayType.Table, DisplayDirection.Default, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-table-row", DisplayType.TableRow, DisplayDirection.Default, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-table-cell", DisplayType.TableCell, DisplayDirection.Default, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-flex flex-row", DisplayType.Flex, DisplayDirection.Row, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-flex flex-column", DisplayType.Flex, DisplayDirection.Column, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-inline-flex flex-row", DisplayType.InlineFlex, DisplayDirection.Row, Breakpoint.Full2K )]
    ...
    [InlineData( "d-xxl-inline-flex flex-column", DisplayType.InlineFlex, DisplayDirection.Column, Breakpoint.Full2K )]
