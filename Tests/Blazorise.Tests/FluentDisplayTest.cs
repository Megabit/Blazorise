...
namespace Blazorise.Tests
{
    public class FluentDisplayTest
    {
        ...
        [Theory]
        [InlineData( "d-xs-none", DisplayType.None, DisplayDirection.None, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-inline", DisplayType.Inline, DisplayDirection.None, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-inline-block", DisplayType.InlineBlock, DisplayDirection.None, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-block", DisplayType.Block, DisplayDirection.None, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-table", DisplayType.Table, DisplayDirection.None, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-table-row", DisplayType.TableRow, DisplayDirection.None, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-table-cell", DisplayType.TableCell, DisplayDirection.None, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-flex flex-row", DisplayType.Flex, DisplayDirection.Row, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-flex flex-column", DisplayType.Flex, DisplayDirection.Column, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-inline-flex flex-row", DisplayType.InlineFlex, DisplayDirection.Row, Breakpoint.Mobile )]
        ...
        [InlineData( "d-xs-inline-flex flex-column", DisplayType.InlineFlex, DisplayDirection.Column, Breakpoint.Mobile )]
