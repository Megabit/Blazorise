...
public class FluentMarginTest
{
    ...
    [InlineData( "m-xxl-1", SpacingSize.Is1, Side.All, Breakpoint.QuadHD )]
    ...
    [InlineData( "mt-xxl-1", SpacingSize.Is1, Side.Top, Breakpoint.QuadHD )]
    ...
    [InlineData( "mb-xxl-1", SpacingSize.Is1, Side.Bottom, Breakpoint.QuadHD )]
    ...
    [InlineData( "ml-xxl-1", SpacingSize.Is1, Side.Start, Breakpoint.QuadHD )]
    ...
    [InlineData( "mr-xxl-1", SpacingSize.Is1, Side.End, Breakpoint.QuadHD )]
    ...
    [InlineData( "mx-xxl-1", SpacingSize.Is1, Side.X, Breakpoint.QuadHD )]
    ...
    [InlineData( "my-xxl-1", SpacingSize.Is1, Side.Y, Breakpoint.QuadHD )]
