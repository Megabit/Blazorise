...
@code{
    ...
    <TableHeader>
        <TableRow>
            ...
            <TableHeaderCell Width=""@Width.Px(100)"">Column heading</TableHeaderCell>
            <TableHeaderCell Width=""@Width.Px(150)"" FixedPosition=""TableColumnFixedPosition.Start"">Fixed heading</TableHeaderCell>
            <TableHeaderCell Width=""@Width.Px(100)"">Column heading</TableHeaderCell>
            <TableHeaderCell Width=""@Width.Px(450)"">Column heading</TableHeaderCell>
            <TableHeaderCell Width=""@Width.Px(230)"">Column heading</TableHeaderCell>
            <TableHeaderCell Width=""@Width.Px(120)"" FixedPosition=""TableColumnFixedPosition.End"">Fixed end heading</TableHeaderCell>
            <TableHeaderCell Width=""@Width.Px(100)"" FixedPosition=""TableColumnFixedPosition.End"">Fixed end heading</TableHeaderCell>
        </TableRow>
    </TableHeader>
    <TableBody>
        @for ( int i = 1; i <= 3; ++i )
        {
            ...
            <TableRow @key=""@index"">
                ...
                <TableRowCell Width=""@Width.Px(100)"">Column content</TableRowCell>
                ...
                <TableRowCell Width=""@Width.Px(450)"">Column content</TableRowCell>
                <TableRowCell Width=""@Width.Px(230)"">Column content</TableRowCell>
                <TableRowCell Width=""@Width.Px(120)"" FixedPosition=""TableColumnFixedPosition.End"">Fixed end content</TableRowCell>
                <TableRowCell Width=""@Width.Px(100)"" FixedPosition=""TableColumnFixedPosition.End"">Fixed end content</TableRowCell>
            </TableRow>
        }
    </TableBody>
</Table>";
