...
public static class ManualPageEntries
{
    ...
    new( "docs/components/context-menu", "Context Menu", "Show contextual actions when a user right-clicks a target element or when application code opens the menu." ),
    ...
    new( "docs/components/dock-layout", "Dock Layout", "Build IDE-like workspaces with docked panes, document areas, tab groups, splitters, auto-hide panes, and restorable layout state." ),
    ...
    new( "docs/components/focus-trap", "Focus Trap", "Manages focus of the forms and its input elements." ),
    ...
    new( "docs/components/property-grid", "Property Grid", "Display and edit related values in a compact inspector with grouping, sorting, search, and contextual help." ),
    ...
    new( "docs/extensions/chart-datalabels", "Chart Data Labels", "Display labels on data for any type of charts." ),
    ...
    new( "docs/extensions/code-editor", "Code Editor", "Edit source code and custom languages with syntax highlighting, diagnostics, completion, and formatting." ),
    ...
    new( "docs/extensions/svg-chart-zoom", "SVG Chart Zoom and Pan", "Enable zoom and pan interactions in native SVG charts." ),
    new( "docs/extensions/datagrid/aggregates", "Data Grid Aggregates" ),

    new( "docs/extensions/datagrid/getting-started", "Data Grid", "The DataGrid component is used for displaying tabular data. Features include sorting, searching, pagination, content-editing, and row selection." ),

    new( "docs/extensions/datagrid/binding-data", "Data Grid Binding Data" ),
    new( "docs/extensions/datagrid/binding-data/in-memory", "Data Grid Binding Data : In Memory", "The DataGrid can bind to your data in memory, allowing for quick and efficient display of your data sets." ),
    new( "docs/extensions/datagrid/binding-data/large-data", "Data Grid Binding Data : Large Data", "The DataGrid Read Data feature allows you to handle Large Data by providing you with a centralized ReadData Method that allows you to query your data by pages." ),
    new( "docs/extensions/datagrid/binding-data/virtualize", "Data Grid Binding Data : Virtualize", "Optimize performance for large data sets with the Blazorise DataGrid's virtualization feature. By only rendering the data currently visible on the screen, virtualization reduces the amount of DOM elements, resulting in improved performance and load times." ),
    new( "docs/extensions/datagrid/binding-data/observable", "Data Grid Binding Data : Observable Data", "The DataGrid can bind observable data, so whenever the underlying collection is changed the DataGrid is automatically updated." ),
    new( "docs/extensions/datagrid/binding-data/dynamic", "Data Grid Binding Data : Dynamic", "The DataGrid can bind to your dynamic data, allowing for greater flexibility." ),

    new( "docs/extensions/datagrid/columns", "Data Grid Columns", "Learn to use and work with the Blazorise DataGrid Columns to customize and configure the columns in a data grid. Explore various column types, such as text, numeric, date, and boolean, to display and manipulate data effectively. Utilize column-specific features like sorting, filtering, and formatting to enhance the presentation and functionality of your data grid. Gain expertise in creating custom columns to meet specific requirements and provide tailored data visualization options." ),

    new( "docs/extensions/datagrid/features", "Data Grid Features" ),
    new( "docs/extensions/datagrid/features/context-menu", "Data Grid Context Menu", "Right-click on any row to access options such as editing, deleting, and custom actions." ),
    new( "docs/extensions/datagrid/features/editing", "Data Grid Editing", "The DataGrid can perform some basic CRUD operations on the supplied Data collection." ),
    new( "docs/extensions/datagrid/features/filtering", "Data Grid Filtering", "Quickly search and filter by any column, or customize filter options to fit your needs." ),
    new( "docs/extensions/datagrid/features/auto-generate-columns", "Data Grid Auto Generate Columns", "The DataGrid can automatically generate columns based on the TItem type." ),
    new( "docs/extensions/datagrid/features/column-chooser", "Data Grid Column Chooser", "Enable Column Chooser to allow users to show or hide columns in the DataGrid." ),
    new( "docs/extensions/datagrid/features/fixed-columns", "Data Grid Fixed Columns", "The table columns remains visible as you scroll, making it easy to identify and reference the data in your grid." ),
    new( "docs/extensions/datagrid/features/fixed-header", "Data Grid Fixed Header", "The table header remains visible as you scroll, making it easy to identify and reference the data in your grid." ),
    new( "docs/extensions/datagrid/features/grouping", "Data Grid Grouping", "Grouping feature for Blazorise DataGrid allows you to easily group and organize your data by specific columns." ),
    new( "docs/extensions/datagrid/features/paging", "Data Grid Paging", "Paginate your data with customizable page size options and intuitive navigation controls." ),
    new( "docs/extensions/datagrid/features/reordering", "Data Grid Reordering", "Easily adjust the order of your columns with the Blazorise DataGrid's reordering feature. Drag and drop column by moving them with the mouse." ),
    new( "docs/extensions/datagrid/features/resizing", "Data Grid Resizing", "Easily adjust the size of your columns with the Blazorise DataGrid's resizing feature. Drag and drop column edges to resize, or use customized options to fit your needs." ),
    new( "docs/extensions/datagrid/features/sorting", "Data Grid Sorting", "Blazorise DataGrid offers efficient data sorting with customizable options." ),
    new( "docs/extensions/datagrid/features/header-group", "Data Grid Header Group", "Header Group feature for Blazorise DataGrid allows you to easily group a set of defined columns by rendering a top row header which groups the columns by the defined Caption" ),
    new( "docs/extensions/datagrid/features/state-management", "Data Grid State Management", "You are able to manage the state of the DataGrid by using the provided GetState and LoadState methods." ),
    new( "docs/extensions/datagrid/features/mobile-mode", "Data Grid Mobile Mode", "The table will have a dedicated layout for mobile devices where the columns are stacked on top of each other." ),
    new( "docs/extensions/datagrid/features/hierarchy/detail-row", "Data Grid Templates : Detail Row", "Easily expand and display additional information for each row using the Blazorise DataGrid's detail row template feature." ),
    new( "docs/extensions/datagrid/features/hierarchy/self-reference", "Data Grid Self Reference", "Render hierarchical rows and load child data on demand with expand/collapse triggers and programmatic row control." ),

    new( "docs/extensions/datagrid/selection", "Data Grid Selection" ),
    new( "docs/extensions/datagrid/selection/single", "Data Grid Single Selection", "Easily select and manage a single row of data with the Blazorise DataGrid's single selection feature. Select a row by clicking on it or programmatically, and access the selected data for further use." ),
    new( "docs/extensions/datagrid/selection/multiple", "Data Grid Multiple Selection", "Select and manage multiple rows of data with ease using the Blazorise DataGrid's multiple selection feature. Select rows by clicking on them or programmatically, and access the selected data for further use." ),
    new( "docs/extensions/datagrid/selection/cell", "Data Grid Cell Selection", "Easily select and manage a single cell with the Blazorise DataGrid's cell selection feature." ),
    new( "docs/extensions/datagrid/selection/custom-row-colors", "Data Grid Custom Row Colors", "Easily color code your data with the Blazorise DataGrid's custom row color feature." ),

    new( "docs/extensions/datagrid/templates", "Data Grid Templates" ),
    new( "docs/extensions/datagrid/templates/button-row", "Data Grid Templates : Button Row", "Easily customize the action buttons shown with the Blazorise DataGrid's button row template feature." ),
    new( "docs/extensions/datagrid/templates/commands", "Data Grid Templates : Commands", "Customize your action commands with the Blazorise DataGrid's commands template feature. Assign custom templates to the command column, such as editing and deleting, or add your own custom actions." ),

    new( "docs/extensions/datagrid/templates/display", "Data Grid Templates : Display", "Customize how your data is displayed in each cell using the Blazorise DataGrid's display template feature. Assign custom templates to individual columns, allowing for more control over how your data is displayed. " ),
    new( "docs/extensions/datagrid/templates/edit", "Data Grid Templates : Edit", "Assign custom edit templates to individual columns, allowing for more control over how data is edited." ),
    new( "docs/extensions/datagrid/templates/loading", "Data Grid Templates : Loading", "Customize the loading look of the Blazorise DataGrid with the loading template feature." ),
    new( "docs/extensions/datagrid/templates/row-overlay", "Data Grid Templates : Row Overlay", "When enabled, the Row Overlay feature allows you to display supplementary data or contextual information directly on top of specific rows within the DataGrid." ),

    new( "docs/extensions/datagrid/validations", "Data Grid Validations" ),
    new( "docs/extensions/dropdownlist", "Dropdown List", "The DropdownList component allows you to select a value from a list of predefined items." ),
    ...
    new( "docs/extensions/loadingindicator", "Loading Indicator", "A wrapper component used to add loading indocators UI to other components." ),
    ...
    new( "docs/extensions/onetimeinput", "One Time Input", "Build OTP, verification code, recovery key, and grouped token inputs with auto-advance, paste support, and validation." ),
    new( "docs/extensions/passwordstrength", "Password Strength", "The PasswordStrength component helps users create stronger passwords with configurable policies, validation integration, and localized feedback." ),
    new( "docs/extensions/pdf", "PDF", "Build PDF documents declaratively with Razor components or imperatively with the Blazorise PDF builder API." ),
    new( "docs/extensions/pdfviewer", "PDF Viewer", "A PdfViewer component used to display a regular PDF document." ),
    new( "docs/extensions/pivotgrid", "Pivot Grid", "Create read-only Excel-like pivot tables for multi-dimensional data analysis with rows, columns, aggregates, totals, field chooser, paging, virtualization, and styling." ),
    ...
    new( "docs/extensions/selectlist", "Select List", "The SelectList component allows you to select a value from a list of predefined items." ),
    ...
    new( "docs/extensions/spinkit", "Spin Kit", "A component used to show loading indicators animated with CSS." ),
    new( "docs/extensions/transferlist", "Transfer List", "The TransferList component is a versatile control element in Blazor that facilitates transferring items between two lists within applications." ),
    new( "docs/extensions/treeview", "Tree View", "The TreeView component is a graphical control element that presents a hierarchical view of information." ),
    new( "docs/extensions/video", "Video", "A Video component used to play a regular or streaming media." ),
    new( "docs/extensions/qrcode", "QR Code", "A component used to generate QR codes." ),
    new( "docs/extensions/fluent-validation", "Fluent Validation", "A validation component for building strongly-typed validation rules." ),

    new( "docs/usage/ant-design", "Ant Design Usage" ),
    ...
    new( "docs/helpers/enums/datagrid", "Enums: Data Grid" ),
    ...
    new( "docs/helpers/enums/listgroup", "Enums: List Group" ),
    new( "docs/helpers/enums/snackbar", "Enums: Snackbar" ),
    new( "docs/helpers/enums/spinkit", "Enums: Spin Kit" ),
