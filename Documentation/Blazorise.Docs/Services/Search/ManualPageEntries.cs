...
public static class ManualPageEntries
{
    ...
    new( "docs/components/date", "Date Edit", "DateEdit is an input field that allows the user to enter a date by typing or by selecting from a calendar overlay." ),
    ...
    new( "docs/components/file", "File Edit", "The FileEdit component is a specialized input that provides a clean interface for selecting files." ),
    ...
    new( "docs/components/memo", "Memo Edit", "MemoEdit collect data from the user and allow multiple lines of text." ),
    ...
    new( "docs/components/numeric", "Numeric Edit", "A native numeric <input> component built around the <input type=\"number\">." ),
    ...
    new( "docs/components/time", "Time Edit", "A native time input component build around the <input type=\"time\">." ),
    ...
    new( "docs/components/text", "Text Edit", "The TextEdit allows the user to input and edit text." ),
