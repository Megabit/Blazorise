...
public static class ManualPageEntries
{
    ...
    new( "docs/extensions/reporting/designer", "Reporting Designer", "Configure design mode, the report viewer, toolbar commands, and report state persistence." ),
    new( "docs/extensions/reporting/layout", "Reporting Layout", "Define report pages, bands, fields, lines, rectangles, and layout tables." ),
