...
public static class ManualPageEntries
{
    ...
    new( "docs/components/color", "Color Edit", "The ColorEdit allow the user to select a color." ),
    ...
    new( "docs/components/dateedit", "Date Edit", "DateEdit is an input field that allows the user to enter a date by typing or by selecting from a calendar overlay." ),
    ...
    new( "docs/components/dragdrop", "Drag & Drop", "Quickly drag and drop elements between the containers." ),
    ...
    new( "docs/components/fileedit", "File Edit", "The FileEdit component is a specialized input that provides a clean interface for selecting files." ),
    ...
    new( "docs/components/memoedit", "Memo Edit", "MemoEdit collect data from the user and allow multiple lines of text." ),
    ...
    new( "docs/components/numericedit", "Numeric Edit", "A native numeric <input> component built around the <input type=\"number\">." ),
    ...
    new( "docs/components/timeedit", "Time Edit", "A native time input component build around the <input type=\"time\">." ),
    ...
    new( "docs/components/textedit", "Text Edit", "The TextEdit allows the user to input and edit text." ),
