...
namespace Blazorise.Demo.Pages.Tests
{
    public partial class DataGridPage
    {
        ...
        {
            new()
            {Id = 1,FirstName = "Caro",LastName = "Nizard",EMail = "cnizard0@hc360.com",City = "Faīẕābād",Zip = null,Salary = 51724.19m, DateOfBirth = new DateTime(1983,5,8),
                Salaries = new()
                {
            ...
            new()
            {Id = 3,FirstName = "Enos",LastName = "Clendennen",EMail = "eclendennen2@shareasale.com",City = "Listvyanskiy",Zip = "633224",Salary = 75602.48m, Childrens=1,
                Salaries = new()
                {
