import { addClassToBody, removeClassFromBody } from "../Blazorise/utilities.js?v=2.2.2.0";
import { adjustDialogDimensionsBeforeShow, closeStackedModal, openStackedModal, registerModalDisconnectCleanup, resetAdjustments, unregisterModalDisconnectCleanup } from "../Blazorise/modal.js?v=2.2.2.0";
