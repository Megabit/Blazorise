...
public class AntDesignStyleProvider : StyleProvider
{
    ...
    public override string DropdownAnimationDuration( int? animationDuration )
        => animationDuration.HasValue ? $"--ant-dropdown-animation-duration: {animationDuration.Value}ms" : null;
    ...
    public override string CarouselAnimationDuration( int? animationDuration )
        => animationDuration.HasValue ? $"--ant-carousel-animation-duration: {animationDuration.Value}ms" : null;
    ...
    public override string AlertAnimationDuration( int? animationDuration )
        => animationDuration.HasValue ? $"--ant-alert-animation-duration: {animationDuration.Value}ms" : null;
