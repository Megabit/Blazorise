...
namespace Blazorise.Material
{
    public partial class MaterialJSRunner : Blazorise.JSRunner
    {
        ...
        public override ValueTask UpdateDatePicker( ElementReference elementRef, string elementId, object value )
        {
        ...
        public override ValueTask UpdateTimePicker( ElementReference elementRef, string elementId, object value )
        {
            return runtime.InvokeVoidAsync( $"blazoriseMaterial.timeEdit.update", elementRef, elementId, value );
        }
