...
public class MaterialClassProvider : BootstrapClassProvider
{
    ...
    public override string Button( bool outline ) => "mud-button-root mud-button mud-ripple";

    public override string ButtonColor( Color color, bool outline ) => outline
        ? color.IsNotNullOrDefault() ? $"mud-button-outlined mud-button-outlined-{ToColor( color )}" : $"mud-button-outlined"
        : color.IsNotNullOrDefault() ? $"mud-button-filled mud-button-filled-{ToColor( color )}" : null;

    public override string ButtonSize( Size size, bool outline ) => size == Size.Default ? null
        : outline
            ? $"mud-button-outlined-size-{ToSize( size )}"
            : $"mud-button-filled-size-{ToSize( size )}";

    public override string ButtonBlock( bool outline, bool block ) => block ? $"mud-width-full" : null;

    public override string ButtonActive( bool outline, bool active ) => active ? "active" : null;

    public override string ButtonDisabled( bool outline, bool disabled ) => null;
    ...
    public override string Card() => "mud-paper mud-elevation-1 mud-card";

    public override string CardWhiteText( bool whiteText ) => whiteText ? "text-white" : null;

    public override string CardActions() => "mud-card-actions";

    public override string CardBody() => "mud-card-content";

    public override string CardFooter() => "mud-card-footer";

    public override string CardHeader() => "mud-card-header";

    public override string CardImage() => "mud-card-media";

    public override string CardTitle( bool insideHeader ) => "mud-card-header-content";

    public override string CardTitleSize( bool insideHeader, int? size ) => null;

    public override string CardSubtitle( bool insideHeader ) => "mud-card-header-content";
    ...
    public override string Row() => "mud-grid";
    ...
    public override string Badge() => "mud-chip mud-chip-filled mud-chip-size-medium";

    public override string BadgeColor( Color color ) => color.IsNotNullOrDefault() ? $"mud-chip-color-{ToColor( color )}" : null;

    public override string BadgePill( bool pill ) => null;

    public override string BadgeClose() => null;

    public override string BadgeCloseColor( Color color ) => null;
