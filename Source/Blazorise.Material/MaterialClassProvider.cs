...
{
    class MaterialClassProvider : IClassProvider
    {
        #region Text
        ...
        public virtual string TabPanel() => "tab-pane fade";
        ...
        public virtual string Nav() => "nav nav-tabs-material";
        ...
        public virtual string Bar() => "navbar navbar-full";
