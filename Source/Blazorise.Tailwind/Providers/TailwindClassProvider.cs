...
public class TailwindClassProvider : ClassProvider
{
    ...
    public override string DatePickerCalendarMonth( bool selected, bool disabled, bool focused )
        => $"tw-datepicker-month{( selected ? " tw-datepicker-month-selected border-blue-600 bg-blue-600 text-white" : null )}{( disabled ? " tw-datepicker-month-disabled" : null )}{( focused ? " tw-datepicker-month-focused ring-2 ring-blue-500 ring-offset-1" : null )} cursor-pointer rounded-md border border-transparent bg-transparent px-2 py-3 text-sm hover:bg-gray-100 disabled:cursor-not-allowed disabled:border-transparent disabled:opacity-25 dark:hover:bg-gray-700";
