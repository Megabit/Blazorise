...
public partial class CloseButton
{
    ...
    protected override void BuildClasses( ClassBuilder builder )
    {
        ...
        {
            builder.Append( "absolute top-0 right-0 ml-auto mx-1.5 my-1.5 p-1.5 h-8 w-8" );
        ...
        {
            builder.Append( "items-center float-right text-gray-400 bg-transparent hover:text-gray-900 p-1.5 ml-auto dark:hover:text-white" );
        }
        else
        {
            builder.Append( "items-center text-gray-400 bg-transparent hover:text-gray-900 rounded-lg p-0.5 ml-2 dark:hover:text-white" );
        }
