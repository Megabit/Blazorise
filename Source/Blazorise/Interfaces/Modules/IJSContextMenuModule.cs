    ...
    IJSDestroyableModule
{
    ...
    /// <param name="clientX">The viewport X coordinate used as the context menu anchor, or <see langword="null"/> to use the target element.</param>
    /// <param name="clientY">The viewport Y coordinate used as the context menu anchor, or <see langword="null"/> to use the target element.</param>
