...
namespace Blazorise.Providers
{
    class BulmaClassProvider : IClassProvider
    {
        ...
        public virtual string Field(/* bool hasCustom*/ ) => "field";

        public virtual string FieldColumn() => $"{Col()}";

        public virtual string FieldColumnSize( ColumnSize columnSize ) => $"is-{ColumnSize( columnSize )}";

        public virtual string FieldHorizontal() => "field-body";

        public virtual string FieldCheck() => "control";

        public virtual string FieldRadio() => "control";

        public virtual string FieldFile() => "file has-name";
        ...
        public virtual string Spacing( Spacing spacing, Side side, int size, Breakpoint breakpoint ) => $"{Spacing( spacing )}{Side( side )}-{size}";

        public virtual string Margin( Side side, int size, Breakpoint breakpoint ) => $"{Spacing( Blazorise.Spacing.Margin )}{Side( side )}-{size}";

        public virtual string Padding( Side side, int size, Breakpoint breakpoint ) => $"{Spacing( Blazorise.Spacing.Padding )}{Side( side )}-{size}";
