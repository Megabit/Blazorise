...
/// <summary>
/// Base component for text inputs that expose typed class and style customization.
/// </summary>
...
public abstract class BaseTextInput<TValue, TClasses, TStyles> : BaseTextInput<TValue>
