...
/// <summary>
/// Base component for buffered text inputs that expose typed class and style customization.
/// </summary>
...
public abstract class BaseBufferedTextInput<TValue, TClasses, TStyles> : BaseBufferedTextInput<TValue>
