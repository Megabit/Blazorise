...
/// <summary>
/// Defines a document event subscription handled by <see cref="IDocumentObserver"/>.
/// </summary>
public class DocumentObserverSubscription
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the document event types to observe.
    /// </summary>
    public DocumentEventTypes EventTypes { get; set; }
    ...
    /// <summary>
    /// Gets or sets the document event handler.
    /// </summary>
    public Func<DocumentEventArgs, Task> Handler { get; set; }
}
