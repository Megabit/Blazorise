...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RatingTooltip"/> class with specified tooltip text.
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RatingTooltip"/> class with specified tooltip text and placement.
    /// </summary>
    /// <param name="text">The text to display in the tooltip.</param>
    /// <param name="placement">The placement of the tooltip relative to its component.</param>
    public RatingTooltip( string text, TooltipPlacement placement )
    {
        Text = text;
        Placement = placement;
    }
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RatingTooltip"/> class with specified tooltip text, placement, multiline option, and arrow visibility.
    /// </summary>
    /// <param name="text">The text to display in the tooltip.</param>
    /// <param name="placement">The placement of the tooltip relative to its component.</param>
    ...
    public RatingTooltip( string text, TooltipPlacement placement, bool multiline, bool showArrow )
    {
        Text = text;
        Placement = placement;
        Multiline = multiline;
