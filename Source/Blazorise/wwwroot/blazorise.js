...
window.blazorise = {
    ...
    dateEdit: {
        ...
        initialize: (element, elementId, options) => {
            ...
            window.blazorise.dateEdit._pickers[elementId] = picker;
        },

        destroy: (element, elementId) => {
            const instances = window.blazorise.dateEdit._pickers || {};
            delete instances[elementId];
        },

        updateValue: (element, elementId, value) => {
            const picker = window.blazorise.dateEdit._pickers[elementId];
    ...
    timeEdit: {
        ...
        initialize: (element, elementId, options) => {
            ...
            window.blazorise.timeEdit.pickers[elementId] = picker;
        },

        destroy: (element, elementId) => {
            const instances = window.blazorise.timeEdit.pickers || {};
            delete instances[elementId];
        },

        updateValue: (element, elementId, value) => {
            const picker = window.blazorise.timeEdit.pickers[elementId];
