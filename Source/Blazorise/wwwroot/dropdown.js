...
import { createPopper } from "./popper.js?v=1.1.0.0-preview1";
import { createAttributesObserver, observeClassChanged, destroyObserver } from "./observer.js?v=1.1.0.0-preview1";
