...
function initialize(element, elementId, options) {
  ...
  var alwaysActiveOptions = options.alwaysActive ? {
    showOnCreate: true,
    hideOnClick: false,
    trigger: "manual"
  } : {};
  var instance = tippy(element, _objectSpread(_objectSpread({}, defaultOptions), alwaysActiveOptions));
...
function destroy(element, elementId) {
  ...
  var instance = instances[elementId];
...
function updateContent(element, elementId, content) {
