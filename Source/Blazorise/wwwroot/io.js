...
function readFileData(element, fileEntryId, position, length) {
...
function getArrayBufferFromFileAsync(element, fileId) {
  var file = getFileById(element, fileId); // On the first read, convert the FileReader into a Promise<ArrayBuffer>
