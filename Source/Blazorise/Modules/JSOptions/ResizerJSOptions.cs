...
/// <summary>
/// Represents JavaScript options for a <see cref="Resizer"/>.
/// </summary>
public class ResizerJSOptions
{
    /// <summary>
    /// Supplies logical start and end targets for coordinated resizing.
    /// </summary>
    public ResizerTargets Targets { get; set; }

    /// <summary>
    /// Identifies the target element. When omitted, the resizer's parent element is used.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the provider-resolved class names applied to the resizer while resizing.
    /// </summary>
