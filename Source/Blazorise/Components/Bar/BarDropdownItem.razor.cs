...
public partial class BarDropdownItem : BaseComponent
{
    ...
    protected override void BuildStyles( StyleBuilder builder )
    {
        ...
        builder.Append( FormattableString.Invariant( $"padding-inline-start: {( Indentation * ( ParentDropdownState.NestedIndex + 1d ) ).ToString( CultureInfo.InvariantCulture )}rem" ), ParentDropdownState.IsInlineDisplay );
    }
