...
/// </summary>
public partial class TextInput : BaseBufferedTextInput<string, TextInputClasses, TextInputStyles>, IAsyncDisposable
{
    #region Methods
    ...
    {
        builder.Append( ClassProvider.TextInput( Plaintext ) );
