import "./vendors/chart.js?v=2.0.0.0";

import "./vendors/chartjs-plugin-datalabels.js?v=2.0.0.0";
import "./vendors/chartjs-plugin-annotation.js?v=2.0.0.0";

import "./vendors/luxon.js?v=2.0.0.0";
import "./vendors/chartjs-adapter-luxon.js?v=2.0.0.0";
