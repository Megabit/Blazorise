...
internal sealed class SvgChartRadarSeriesGeometry : ComponentBase
{
    ...
    protected override void BuildRenderTree( RenderTreeBuilder builder )
    {
        ...
        foreach ( var renderedPoint in Points )
        {
            ...
            Context.RenderDataDragHitTarget( builder, ref sequence, Series, point, renderedPoint.MarkerX, renderedPoint.MarkerY, markerRadius );
            ...
            Context.AddPointInteractionAttributes( builder, ref sequence, point, renderedPoint.Color, Series, null, SvgChartSeriesProjectionTransform.MarkerTransformStyleString );
