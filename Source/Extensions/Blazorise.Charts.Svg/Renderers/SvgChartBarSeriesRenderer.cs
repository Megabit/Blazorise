...
internal sealed class SvgChartBarSeriesContent : SvgChartSeriesContentBase
{
    ...
    protected override void BuildRenderTree( RenderTreeBuilder builder )
    {
        ...
        foreach ( var bar in bars )
        {
            ...
            Context.AddPointInteractionAttributes( builder, ref sequence, point, bar.Color, Series );
            ...
            Context.RenderDataDragHitTarget( builder, ref sequence, Series, point, bar.EndPosition, bar.Y + bar.Height / 2, 0 );
        }
    }
