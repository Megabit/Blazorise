...
internal sealed class SvgChartPointSeriesGeometry : ComponentBase
{
    ...
    protected override void OnParametersSet()
    {
        var shouldRender = Context?.Animation.Enabled == true
            || Context?.DataDrag.Enabled == true
            || renderedDataDragEnabled
    ...
    protected override void BuildRenderTree( RenderTreeBuilder builder )
    {
        ...
        foreach ( var renderedPoint in Points )
        {
            ...
            Context.RenderDataDragHitTarget( builder, ref sequence, Series, point, renderedPoint.X, renderedPoint.Y, renderedPoint.Radius );
            ...
            Context.AddPointInteractionAttributes( builder, ref sequence, point, renderedPoint.Color, Series, renderedPoint.Label, SvgChartSeriesProjectionTransform.MarkerTransformStyleString );
