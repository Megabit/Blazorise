...
internal sealed class SvgChartColumnSeriesContent : SvgChartSeriesContentBase
{
    ...
    protected override void BuildRenderTree( RenderTreeBuilder builder )
    {
        ...
        foreach ( var column in columns )
        {
            ...
            Context.AddPointInteractionAttributes( builder, ref sequence, point, column.Color, Series );
            ...
            Context.RenderDataDragHitTarget( builder, ref sequence, Series, point, column.X + column.Width / 2, column.EndPosition, 0 );
        }
    }
