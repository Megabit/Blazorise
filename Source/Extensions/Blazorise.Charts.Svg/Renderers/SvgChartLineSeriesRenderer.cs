    ...
    protected override void BuildRenderTree( RenderTreeBuilder builder )
    {
        ...
        if ( Series.MarkerRadius > 0 )
        {
            ...
            foreach ( var renderedPoint in points )
            {
                ...
                Context.RenderDataDragHitTarget( builder, ref sequence, Series, point, renderedPoint.X, renderedPoint.Y, Series.MarkerRadius );
                ...
                Context.AddPointInteractionAttributes( builder, ref sequence, point, renderedPoint.Color, Series );
