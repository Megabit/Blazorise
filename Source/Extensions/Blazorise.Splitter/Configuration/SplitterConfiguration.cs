...
public class SplitterConfiguration
{
    ...
    /// Direction to split.
    /// </summary>
    [JsonPropertyName( "direction" )] public SplitDirection Direction { get; init; } = SplitDirection.Horizontal;
    ...
    /// </summary>
    [JsonPropertyName( "dragInterval" )] public JavascriptNumber DragInterval { get; init; }
    ...
    /// </summary>
    [JsonPropertyName( "expandToMin" )] public bool? ExpandToMin { get; init; }

    /// <summary>
    /// Determines how the gutter aligns between the two elements.
    /// </summary>
    [JsonPropertyName( "gutterAlign" )] public SplitGutterAlignment GutterAlign { get; init; } = SplitGutterAlignment.Center;

    /// <summary>
    /// Gutter size in pixels.
    /// </summary>
    [JsonPropertyName( "gutterSize" )] public JavascriptNumber GutterSize { get; init; }

    /// <summary>
    /// Maximum size of each element.
    /// </summary>
    [JsonPropertyName( "maxSize" )] public JavascriptNumberOrArray MaxSize { get; init; }

    /// <summary>
    /// Minimum size of each element.
    /// </summary>
    [JsonPropertyName( "minSize" )] public JavascriptNumberOrArray MinSize { get; init; }

    /// <summary>
    /// Initial sizes of each element in percents or CSS values.
    /// </summary>
    [JsonPropertyName( "sizes" )] public IEnumerable<JavascriptNumber> Sizes { get; init; }

    /// <summary>
    /// Snap to minimum size offset in pixels.
    /// </summary>
    [JsonPropertyName( "snapOffset" )] public JavascriptNumberOrArray SnapOffset { get; init; }
}