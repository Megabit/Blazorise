...
(function (global) {
    ...
    function runAnimation(motion, element, settings, original, reversed, completed, isCancelled) {
        ...
        var startAnimation = function startAnimation(targetElement, animationTarget) {
            ...
            var markAnimationComplete = function markAnimationComplete() {
    ...
    global.blazoriseAnimate = global.blazoriseAnimate || {};

    global.blazoriseAnimate.init = function () {
        return loadMotion().then(function () {
            return true;
        });
    };

    global.blazoriseAnimate.refresh = function () {
        return true;
    };

    global.blazoriseAnimate.animate = function (element, options) {
        if (!element) {
            return true;
        }
    ...
    global.blazoriseAnimate.dispose = function (element) {
        cleanup(element);
    };
})(window);
