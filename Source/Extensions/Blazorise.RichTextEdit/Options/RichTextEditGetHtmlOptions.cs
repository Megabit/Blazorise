...
/// </summary>
public class RichTextEditGetHtmlOptions
{
    /// <summary>
    ...
    /// <summary>
    /// Creates a new <see cref="RichTextEditGetHtmlOptions"/> instance for retrieving raw inner HTML content.
    /// </summary>
    /// <returns>An options object with <see cref="IsSemanticHtml"/> set to <c>false</c>.</returns>
    public static RichTextEditGetHtmlOptions InnerHtml()
        => new() { IsSemanticHtml = false };

    /// <summary>
    /// Creates a new <see cref="RichTextEditGetHtmlOptions"/> instance for retrieving semantic HTML content.
    /// </summary>
    ...
    public static RichTextEditGetHtmlOptions SemanticHtml( int index = 0, int? length = null ) =>
