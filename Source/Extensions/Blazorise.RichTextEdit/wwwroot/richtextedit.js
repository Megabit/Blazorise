import "./vendors/quill.js?v=2.2.3.0";
...
async function loadSanitizedPasteModule() {
    ...
    if (!rteSanitizedPasteLoader) {
        rteSanitizedPasteLoader = import("./vendors/quill-paste-smart.js?v=2.2.3.0")
            .then((module) => {
...
async function loadTableBetterModule() {
    ...
    if (!rteTableBetterLoader) {
        rteTableBetterLoader = import("./vendors/quill-table-better.js?v=2.2.3.0")
            .then(() => {
...
async function loadResizeModule() {
    ...
    if (!rteResizeLoader) {
        rteResizeLoader = import("./vendors/quill-resize-module.js?v=2.2.3.0")
            .then(() => {
