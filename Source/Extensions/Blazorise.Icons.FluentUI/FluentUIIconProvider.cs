...
class FluentUIIconProvider : BaseIconProvider
{
    ...
    private static Dictionary<IconName, string> names = new()
    {
        ...
        { IconName.ChevronDoubleDown, FluentUIIcons.ChevronDoubleDown },
        { IconName.ChevronDoubleLeft, FluentUIIcons.ChevronDoubleLeft },
        { IconName.ChevronDoubleRight, FluentUIIcons.ChevronDoubleRight },
        { IconName.ChevronDoubleUp, FluentUIIcons.ChevronDoubleUp },
        ...
        { IconName.Minus, FluentUIIcons.Subtract },
        ...
        { IconName.Plus, FluentUIIcons.Add },
