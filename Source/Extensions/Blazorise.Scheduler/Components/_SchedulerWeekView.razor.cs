...
public partial class _SchedulerWeekView<TItem>
{
    ...
    /// <summary>
    /// Specifies the optional starting time for the visible scheduler range.
    /// </summary>
    [Parameter] public TimeOnly StartTime { get; set; }

    /// <summary>
    /// Specifies the optional ending time for the visible scheduler range.
    /// </summary>
    [Parameter] public TimeOnly EndTime { get; set; }

    /// <summary>
    /// Specifies the optional start time for the workday hours.
    /// </summary>
    [Parameter] public TimeOnly? WorkDayStart { get; set; }

    /// <summary>
    /// Specifies the optional end time for the workday hours.
    /// </summary>
    [Parameter] public TimeOnly? WorkDayEnd { get; set; }

    /// <summary>
    /// Specifies the number of time slots within a single cell (hour).
    /// </summary>
    [Parameter] public int SlotsPerCell { get; set; }

    /// <summary>
    /// Specifies the height in pixels of the header cells.
    /// </summary>
    [Parameter] public double HeaderCellHeight { get; set; }

    /// <summary>
    /// Specifies the height in pixels of the item cells.
    /// </summary>
