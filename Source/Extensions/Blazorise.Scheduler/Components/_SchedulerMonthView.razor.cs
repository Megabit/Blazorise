...
public partial class _SchedulerMonthView<TItem>
{
    ...
    /// <summary>
    /// Specifies the parent scheduler instance.
    /// </summary>
    ...
    /// <summary>
    /// Specifies the earliest time of day that can be shown or used in the month view.
    /// </summary>
    [Parameter] public TimeOnly StartTime { get; set; }

    /// <summary>
    /// Specifies the latest time of day that can be shown or used in the month view.
    /// </summary>
    [Parameter] public TimeOnly EndTime { get; set; }

    /// <summary>
    /// Specifies the start of the working hours for visual styling (e.g., highlighting working time).
    /// </summary>
    [Parameter] public TimeOnly? WorkDayStart { get; set; }

    /// <summary>
    /// Specifies the end of the working hours for visual styling.
    /// </summary>
    [Parameter] public TimeOnly? WorkDayEnd { get; set; }

    /// <summary>
    /// Specifies the height, in pixels, of the header row (typically for day names).
    /// </summary>
    [Parameter] public double HeaderCellHeight { get; set; }

    /// <summary>
    /// Specifies the height, in pixels, of each cell used to display items in the calendar.
    /// </summary>
