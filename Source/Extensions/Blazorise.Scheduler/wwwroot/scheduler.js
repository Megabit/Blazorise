import { getRequiredElement, insertCSSIntoDocumentHead } from "../Blazorise/utilities.js?v=2.0.4.0";

insertCSSIntoDocumentHead("_content/Blazorise.Scheduler/scheduler.css?v=2.0.4.0");
