...
internal class JSReCaptchaModule : BaseJSModule, IJSDestroyableModule
{
    ...
    public ValueTask Initialize( DotNetObjectReference<ReCaptcha> dotNetObjectReference, ElementReference elementRef, string elementId, ReCaptchaInitializeJSOptions options )
