import { getChart, compileOptionCallbacks } from "../Blazorise.Charts/charts.js?v=1.1.0.0-preview1";
import { deepClone } from "../Blazorise.Charts/utilities.js?v=1.1.0.0-preview1";
