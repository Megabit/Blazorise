import "./vendors/easymde.js?v=2.1.1.0";
import "./vendors/highlight.js?v=2.1.1.0";
import { getRequiredElement, registerDisconnectCleanup, unregisterDisconnectCleanup } from "../Blazorise/utilities.js?v=2.1.1.0";
import { removeAllFileEntries } from "../Blazorise/io.js?v=2.1.1.0";

document.getElementsByTagName("head")[0].insertAdjacentHTML("beforeend", "<link rel=\"stylesheet\" href=\"_content/Blazorise.Markdown/vendors/easymde.css?v=2.1.1.0\" />");
document.getElementsByTagName("head")[0].insertAdjacentHTML("beforeend", "<link rel=\"stylesheet\" href=\"_content/Blazorise.Markdown/markdown.css?v=2.1.1.0\" />");
