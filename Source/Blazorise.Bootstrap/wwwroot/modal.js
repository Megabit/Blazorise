import { addClassToBody, removeClassFromBody } from "../Blazorise/utilities.js?v=2.1.3.0";
import { adjustDialogDimensionsBeforeShow, closeStackedModal, openStackedModal, registerModalDisconnectCleanup, resetAdjustments, unregisterModalDisconnectCleanup } from "../Blazorise/modal.js?v=2.1.3.0";
