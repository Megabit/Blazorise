...
public class Framework7ThemeGenerator : ThemeGenerator
{
    #region Constructors

    public Framework7ThemeGenerator( IThemeCache themeCache )
        : base( themeCache )
    {
    }
