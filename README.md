...
The `?v=2.1.3.0` query string matches the current Blazorise package version (2.1.3) and is used for cache busting. Update it whenever you upgrade Blazorise packages. If you use a different provider, swap the Bootstrap CSS and provider-specific Blazorise CSS file accordingly.
