...
<link href="_content/Blazorise/blazorise.css?v=2.3.1.0" rel="stylesheet" />
<link href="_content/Blazorise.Bootstrap5/blazorise.bootstrap5.css?v=2.3.1.0" rel="stylesheet" />
```

The `?v=2.3.1.0` query string matches the current Blazorise package version (2.2.3) and is used for cache busting. Update it whenever you upgrade Blazorise packages. If you use a different provider, swap the Bootstrap CSS and provider-specific Blazorise CSS file accordingly.
